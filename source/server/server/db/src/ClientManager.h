...
public:
	...
	void			ForwardPacket(BYTE header, const void* data, int size, BYTE bChannel = 0, CPeer* except = nullptr);
...
private:
	...
	bool		InitializeBossGemShopTable();
	#endif
#endif
	...
	void		QUERY_PARTY_SET_MEMBER_MAP_INDEX(CPeer* peer, TPacketPartySetMemberMapIndex* p);
	void		QUERY_PARTY_SET_MEMBER_CHANNEL(CPeer* peer, TPacketPartySetMemberChannel* p);
#endif
