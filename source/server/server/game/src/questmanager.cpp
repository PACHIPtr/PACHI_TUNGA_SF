...
namespace quest
{
	...
	void CQuestManager::SendScript()
	{
		...
		{
			if (GetCurrentCharacterPtr()->GetDesc())
	...
	void CQuestManager::SetEventFlag(const string & name, int value)
	{
		...
		else if (name == "ex_moon_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_MOON_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_HEXAGON_DROP_EVENT
		else if (name == "ex_hexagon_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_HEXAGON_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_CARVING_STONE_EVENT
		else if (name == "ex_carving_stone_drop")
		{
			CGameEventsManager::instance().SetActivateEvent(EVENT_CARVING_STONE_DROP, value != 0 ? true : false);
			if (value == 1) {
				eventmanager::SpawnEasterNpc(true);
			}
			else {
				eventmanager::SpawnEasterNpc(false);
			}
		}
	#endif
			...
			if (value == 1) {
				eventmanager::SpawnRamadanHistorianNpc(true);
				eventmanager::SpawnRamadanBeggar1Npc(true);
				eventmanager::SpawnRamadanBeggar2Npc(true);
				eventmanager::SpawnRamadanBeggar3Npc(true);
				eventmanager::SpawnRamadanBeggar4Npc(true);
				eventmanager::SpawnRamadanBeggar5Npc(true);
			}
			else {
				eventmanager::SpawnRamadanHistorianNpc(false);
				eventmanager::SpawnRamadanBeggar1Npc(false);
				eventmanager::SpawnRamadanBeggar2Npc(false);
				eventmanager::SpawnRamadanBeggar3Npc(false);
				eventmanager::SpawnRamadanBeggar4Npc(false);
				eventmanager::SpawnRamadanBeggar5Npc(false);
			}
		}
	#endif
		...
		else if (name == "ex_football_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_FOOTBALL_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_VALENTINE_EVENT
		else if (name == "ex_valentine_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_VALENTINE_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_PET_EVENT
		else if (name == "ex_pet_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_PET_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_KIDS_DAY_EVENT
		else if (name == "ex_kids_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_KIDS_DAY_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_HALLOWEEN_EVENT
		else if (name == "ex_halloween_drop") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_HALLOWEEN, value != 0 ? true : false);
		}
	#endif
	#ifdef ENABLE_OLYMPIC_EVENT
		else if (name == "ex_olympic_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_OLYMPIC_BADGE, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_MINIGAME_RUMI_EVENT
		else if (name == "cards_event") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_OKEY_CARD, value != 0 ? true : false);
			if (value > 0) {
				eventmanager::SpawnCardNpc(true);
			}
			else {
				eventmanager::SpawnCardNpc(false);
			}
		}
	#endif
	#ifdef ENABLE_MOUNT_EVENT
		else if (name == "ex_mount_drop")
			CGameEventsManager::instance().SetActivateEvent(EVENT_MOUNT_DROP, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_ALIGNMENT_EVENT
		else if (name == "alignment_event")
			CGameEventsManager::instance().SetActivateEvent(EVENT_ALIGNMENT, value != 0 ? true : false);
	#endif
	#ifdef ENABLE_YEAR_ROUND_EVENT
		else if (name == "2017_year_round_event") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_YEAR_ROUND, value != 0 ? true : false);
			if (value > 0) {
				eventmanager::SpawnShadowWarriorMob(true);
				eventmanager::SpawnYearRoundMerchant(true);
				eventmanager::SpawnYearRoundCherie(true);
			}
			else {
				eventmanager::SpawnShadowWarriorMob(false);
				eventmanager::SpawnYearRoundMerchant(false);
				eventmanager::SpawnYearRoundCherie(false);
			}
		}
	#endif
	#ifdef ENABLE_FISH_JIGSAW_EVENT
		else if (name == "2018_fish_event") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_NEW_FISH, value != 0 ? true : false);
		}
	#endif
	#ifdef ENABLE_MINING_EVENT
		else if (name == "mining_event") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_MINING, value != 0 ? true : false);
		}
	#endif
	#ifdef ENABLE_HARVEST_FESTIVAL_EVENT
		else if (name == "harvest_festival") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_HARVEST_FESTIVAL, value != 0 ? true : false);
		}
	#endif
	#ifdef ENABLE_MAKE_WONSO_EVENT
		else if (name == "newyear_wonso") {
			CGameEventsManager::instance().SetActivateEvent(EVENT_MAKE_WONSO, value != 0 ? true : false);
		}
	#endif
#ifdef ENABLE_ATTENDANCE_EVENT
		else if (name == "enable_attendance_event")
		{
			...
			CGameEventsManager::instance().SetActivateEvent(EVENT_BOSS_HUNTERS, value != 0 ? true : false);
		}
		...
		else if (name == "enable_catch_king_event")
		{
			...
			CGameEventsManager::instance().SetActivateEvent(EVENT_CATCH_KING, value != 0 ? true : false);
		}
		...
		else if (name == "golden_rain_event")
		{
			CGameEventsManager::instance().SetActivateEvent(EVENT_GOLDEN_RAIN, value != 0 ? true : false);
		}
	#endif
		...
		else if (name == "lucky_box_event")
		{
			CGameEventsManager::instance().SetActivateEvent(EVENT_LUCKY_BOX, value != 0 ? true : false);
		}
	#endif
#endif
	}
