...
namespace quest
{
	...
	public:
		...
		static bool ExecuteQuestScript(PC& pc, DWORD quest_index, const int state, const char* code, const int code_size, vector<AArgScript*>* pChatScripts = nullptr, bool bUseCache = true);
