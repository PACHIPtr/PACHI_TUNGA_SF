...
bool CLand::RequestCreateWall(long nMapIndex, float rot)
{
	...
	if (rot == 0.0f) 		// 남쪽 문
	{
		int door_rot_x = wall_x;
		int door_rot_y = wall_y + wall_half_h;
		RequestCreateObject(WALL_DOOR_VNUM, nMapIndex, wall_x, wall_y + wall_half_h, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_BACK_VNUM, nMapIndex, wall_x, wall_y - wall_half_h, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_LEFT_VNUM, nMapIndex, wall_x - wall_half_w, wall_y, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_RIGHT_VNUM, nMapIndex, wall_x + wall_half_w, wall_y, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
	}
	else if (rot == 180.0f)		// 북쪽 문
	{
		int door_rot_x = wall_x;
		int door_rot_y = wall_y - wall_half_h;
		RequestCreateObject(WALL_DOOR_VNUM, nMapIndex, wall_x, wall_y - wall_half_h, (float)door_rot_x, (float)door_rot_y, 180.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_BACK_VNUM, nMapIndex, wall_x, wall_y + wall_half_h, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_LEFT_VNUM, nMapIndex, wall_x - wall_half_w, wall_y, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_RIGHT_VNUM, nMapIndex, wall_x + wall_half_w, wall_y, (float)door_rot_x, (float)door_rot_y, 0.0f, WALL_ANOTHER_CHECKING_ENABLE);
	}
	...
	{
		int door_rot_x = wall_x + wall_half_h;
		int door_rot_y = wall_y;
		RequestCreateObject(WALL_DOOR_VNUM, nMapIndex, wall_x + wall_half_h, wall_y, (float)door_rot_x, (float)door_rot_y, 90.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_BACK_VNUM, nMapIndex, wall_x - wall_half_h, wall_y, (float)door_rot_x, (float)door_rot_y, 90.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_LEFT_VNUM, nMapIndex, wall_x, wall_y - wall_half_w, (float)door_rot_x, (float)door_rot_y, 90.0f, WALL_ANOTHER_CHECKING_ENABLE);
		RequestCreateObject(WALL_RIGHT_VNUM, nMapIndex, wall_x, wall_y + wall_half_w, (float)door_rot_x, (float)door_rot_y, 90.0f, WALL_ANOTHER_CHECKING_ENABLE);
	}
