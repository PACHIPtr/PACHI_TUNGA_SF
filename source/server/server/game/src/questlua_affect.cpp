...
namespace quest
{
	...
	ALUA(affect_add_wind_shoes)
	{
		...
		ch->AddAffect(AFFECT_WIND_SHOES, aApplyInfo[applyOn].bPointType, value, AFF_WIND_SHOES, duration, 0, false);
...
#ifdef ENABLE_WIND_SHOES_RENEWAL
			{"add_wind_shoes", affect_add_wind_shoes},
#endif
			{nullptr, nullptr}
		};
