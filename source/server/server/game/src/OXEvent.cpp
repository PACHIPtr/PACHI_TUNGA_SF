...
#ifdef ENABLE_OXEVENT_COORDINAT_BUFF
...
#ifdef ENABLE_OXEVENT_COORDINAT_BUFF
	else if (pos.x == 897500 && pos.y == 24600)
	{
		return EnterAttender(pkChar);
	}
	else if (pos.x == 898500 && pos.y == 24600)
	{
		return EnterAttender(pkChar);
	}
	else if (pos.x == 895500 && pos.y == 24600)
	{
		return EnterAttender(pkChar);
	}
	else if (pos.x == 894500 && pos.y == 24600)
	{
		return EnterAttender(pkChar);
	}
#endif
...
EVENTFUNC(oxevent_timer)
{
	...
	if (info == nullptr)
	{
		sys_err("oxevent_timer> <Factor> nullptr pointer");
		return 0;
	}
