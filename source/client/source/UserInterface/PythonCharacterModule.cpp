...
PyObject * chrIsYoutuber(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsYoutuber());
}

PyObject * chrIsTwitcher(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsTwitcher());
}
#endif
...
PyObject * chrGetPixelPosition(PyObject* poSelf, PyObject* poArgs)
{
	...
	CInstanceBase * pkInst = CPythonCharacterManager::Instance().GetInstancePtr(iVirtualID);
	if (!pkInst)
		return Py_BuildValue("iii", -1000, -1000, -1000);
...
PyObject* chrGetLevel(PyObject* poSelf, PyObject* poArgs)//ticaret ekrani
{
...
PyObject* chrGetLevelByVID(PyObject* poSelf, PyObject* poArgs)//ticaret ekrani
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
...
PyObject* chrIsPoisoned(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", pInstance->IsAffect(CInstanceBase::AFFECT_POISON));
}
#endif
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
...
#ifdef ENABLE_YOUTUBER_SYSTEM
		{ "IsYoutuber",					chrIsYoutuber,						METH_VARARGS },
		{ "IsTwitcher",					chrIsTwitcher,						METH_VARARGS },
#endif
		...
		{"GetLevel", chrGetLevel, METH_VARARGS},//ticaret ekrani
		{"GetLevelByVID", chrGetLevelByVID, METH_VARARGS},//ticaret ekrani
#ifdef ENABLE_POISON_GAUGE_SYSTEM
		{"IsPoisoned", chrIsPoisoned, METH_VARARGS},
#endif
		{ NULL,								NULL,								NULL },
	};
	...
	PyModule_AddIntConstant(poModule, "PART_WEAPON_RIGHT",					CRaceData::PART_WEAPON_RIGHT);
...
#endif
	PyModule_AddIntConstant(poModule, "AFFECT_WIND_SHOES", CInstanceBase::AFFECT_WIND_SHOES);
#ifdef ENABLE_AFK_MODE_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_AFK", CInstanceBase::AFFECT_AFK);
#endif
	PyModule_AddIntConstant(poModule, "AFFECT_PREMIUM", CInstanceBase::AFFECT_PREMIUM);
	...
	PyModule_AddIntConstant(poModule, "MOTION_ALCOHOL",				CRaceMotionData::NAME_ALCOHOL);
	PyModule_AddIntConstant(poModule, "MOTION_SIREN",				CRaceMotionData::NAME_SIREN);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER_1",			CRaceMotionData::NAME_WEATHER_1);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER_2",			CRaceMotionData::NAME_WEATHER_2);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER_3",			CRaceMotionData::NAME_WEATHER_3);
	PyModule_AddIntConstant(poModule, "MOTION_WHIRL",				CRaceMotionData::NAME_WHIRL);
	PyModule_AddIntConstant(poModule, "MOTION_CHARGING",			CRaceMotionData::NAME_CHARGING);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SHOP_DECO",				CInstanceBase::NEW_AFFECT_SHOP_DECO);
#endif

#ifdef ENABLE_KING_GUILD_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_KING_GUILD",					CInstanceBase::AFFECT_KING_GUILD);
#endif
}
