...
class FloatingChat
{
	...
	public:
		...
		static FloatingChat* New();
		static void Delete(FloatingChat* pkWhisper);

		static CDynamicPool<FloatingChat>		ms_kPool;
};
...
class CPythonChat : public CSingleton<CPythonChat>, public IAbstractChat
{
	public:
		...
		typedef std::map<std::string, FloatingChat*> TWhisperMap;
