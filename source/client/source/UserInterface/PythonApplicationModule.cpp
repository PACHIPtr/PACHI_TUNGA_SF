...
PyObject * appPlayVideo(PyObject* poSelf, PyObject* poArgs)
{
	char* szName;
	if (!PyTuple_GetString(poArgs, 0, &szName))
		return Py_BuildException(); 
...
void initapp()
{
	...
	{	
		...
		{ "PlayVideo",					appPlayVideo,					METH_VARARGS },
		{ nullptr, nullptr },
	};
	...
	PyModule_AddIntConstant(poModule, "VERSION",				GAME_VERSION);
	...
	PyModule_AddIntConstant(poModule, "ENABLE_VERSION_162_ENABLED", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VERSION_162_ENABLED", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_HIGHLIGHT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_HIGHLIGHT_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MINIGAME_RUMI_EVENT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MINIGAME_RUMI_EVENT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SEALBIND_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SEALBIND_SYSTEM",	0);
#endif

#ifdef WJ_TRADABLE_ICON
	PyModule_AddIntConstant(poModule, "WJ_TRADABLE_ICON", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_TRADABLE_ICON", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TALISMAN_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TALISMAN_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_UPDATE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_INFORMATION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_INFORMATION_SYSTEM", 0);
#endif

#ifdef ENABLE_VIEW_ELEMENT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_ELEMENT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VIEW_ELEMENT_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_BATTLE_ZONE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BATTLE_ZONE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_COMBINATION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_COMBINATION_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ENCHANT_COSTUME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ENCHANT_COSTUME_SYSTEM", 0);
#endif

#ifdef ENABLE_UPGRADE_SOCKET_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_UPGRADE_SOCKET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_UPGRADE_SOCKET_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_WINDOW_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_WINDOW_SYSTEM", 0);
#endif

#ifdef ENABLE_EXTEND_INVENTORY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_INVENTORY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_INVENTORY_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_YOUTUBER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_YOUTUBER_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WEAPON_RARITY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WEAPON_RARITY_SYSTEM", 0);
#endif

#ifdef ENABLE_FISH_JIGSAW_EVENT
	PyModule_AddIntConstant(poModule, "ENABLE_FISH_JIGSAW_EVENT",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FISH_JIGSAW_EVENT",	0);
#endif

#ifdef ENABLE_ZODIAC_TEMPLE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_12ZI", 1);
	PyModule_AddIntConstant(poModule, "ENABLE_ZODIAC_TEMPLE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_12ZI", 0);
	PyModule_AddIntConstant(poModule, "ENABLE_ZODIAC_TEMPLE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MAIL_BOX_SYSTEM",	1);
	#ifdef USE_TRANSMUTATION_SYSTEM_MAILBOX
		PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION_MAIL_BOX_SYSTEM",	1);
	#else
		PyModule_AddIntConstant(poModule, "ENABLE_TRANSMUTATION_MAIL_BOX_SYSTEM",	0);
	#endif
	#ifdef USE_WON_SYSTEM_MAILBOX
		PyModule_AddIntConstant(poModule, "ENABLE_WON_MAIL_BOX_SYSTEM",	1);
	#else
		PyModule_AddIntConstant(poModule, "ENABLE_WON_MAIL_BOX_SYSTEM",	0);
	#endif
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MAIL_BOX_SYSTEM",	0);
#endif
...
#ifdef ENABLE_CUBE_EX_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_EX_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_EX_RENEWAL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SOLD_ITEM_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SOLD_ITEM_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_DAMAGE_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_DAMAGE_RENEWAL", 0);
#endif

#ifdef ENABLE_SAFEBOX_MONEY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_MONEY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAFEBOX_MONEY_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WORSHIP_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WORSHIP_SYSTEM", 0);
#endif

#ifdef ENABLE_CAPTCHA_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CAPTCHA_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CAPTCHA_SYSTEM", 0);
#endif

#ifdef ENABLE_EMOJI_IN_TEXTLINE
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_IN_TEXTLINE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_IN_TEXTLINE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EFFECT_STONE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EFFECT_STONE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_RENEWAL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_AFFECT_REMOVE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_AFFECT_REMOVE", 0);
#endif

#ifdef ENABLE_FAST_CHEQUE_GOLD_TRANSFER
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEQUE_GOLD_TRANSFER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEQUE_GOLD_TRANSFER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MUSHROOM_DUNGEON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MUSHROOM_DUNGEON", 0);
#endif

#ifdef ENABLE_WATER_DUNGEON
	PyModule_AddIntConstant(poModule, "ENABLE_WATER_DUNGEON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WATER_DUNGEON", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_HUNTING_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_HUNTING_SYSTEM", 0);
#endif

#ifdef ENABLE_KING_GUILD_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_KING_GUILD_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_KING_GUILD_SYSTEM", 0);
#endif

#ifdef ENABLE_AVERAGE_ITEM_PRICE
	PyModule_AddIntConstant(poModule, "ENABLE_AVERAGE_ITEM_PRICE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AVERAGE_ITEM_PRICE", 0);
#endif

#ifdef ENABLE_PERMA_ACCESSORY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_ACCESSORY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_ACCESSORY_SYSTEM", 0);
#endif

#ifdef ENABLE_GUILD_RANKING_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_RANKING_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_RANKING_SYSTEM", 0);
#endif

#ifdef ENABLE_BOSS_GEM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_GEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_GEM_SYSTEM", 0);
#endif

#ifdef ENABLE_BONUS_TO_BOSS
	PyModule_AddIntConstant(poModule, "ENABLE_BONUS_TO_BOSS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BONUS_TO_BOSS", 0);
#endif

#ifdef ENABLE_SPECIAL_GACHA_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_GACHA_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_GACHA_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_BLEND_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_BLEND_SYSTEM", 0);
#endif

#ifdef ENABLE_BLEND_ICON_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_ICON_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_ICON_SYSTEM", 0);
#endif

#ifdef ENABLE_ITEM_COLOR_HIGHLIGHT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_COLOR_HIGHLIGHT_SYSTEM", 1);
#else
