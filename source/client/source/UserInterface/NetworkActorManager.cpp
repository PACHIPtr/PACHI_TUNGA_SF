...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	is_support_shaman = src.is_support_shaman;
#endif
	...
	m_dwWeaponRareLv = src.m_dwWeaponRareLv;
#endif
#ifdef ENABLE_EFFECT_STONE_SYSTEM
	m_dwStoneEffect = src.m_dwStoneEffect;
	m_dwWeaponStoneEffect = src.m_dwWeaponStoneEffect;
#endif
...
CInstanceBase* CNetworkActorManager::__AppendCharacterManagerActor(SNetworkActorData& rkNetActorData)
{
...
#endif
#ifdef ENABLE_BUFFI_SYSTEM
	kCreateData.is_support_shaman = rkNetActorData.is_support_shaman;
#endif
#ifdef ENABLE_GUILD_LEADER_SYSTEM
	kCreateData.m_bMemberType = rkNetActorData.m_bMemberType;
#endif
#ifdef ENABLE_WEAPON_RARITY_SYSTEM
	kCreateData.m_dwWeaponRareLv = rkNetActorData.m_dwWeaponRareLv;
#endif
...
#endif
#ifdef ENABLE_EFFECT_STONE_SYSTEM
	kCreateData.m_dwStoneEffect=rkNetActorData.m_dwStoneEffect;
	kCreateData.m_dwWeaponStoneEffect=rkNetActorData.m_dwWeaponStoneEffect;
#endif
#ifdef ENABLE_AURA_SYSTEM
	...
	if (pOldInstance)
	{
		...
		int bIsMountingHorse = pOldInstance->IsMountingHorse();
...
void CNetworkActorManager::AppendActor(const SNetworkActorData& c_rkNetActorData)
{
	if (__IsMainActorVID(c_rkNetActorData.m_dwVID))
	{
		...
		if( pMainInstance )
		{
			int bIsMountingHorse = pMainInstance->IsMountingHorse();
...
void CNetworkActorManager::UpdateActor(const SNetworkUpdateActorData& c_rkNetUpdateActorData)
{
	...
	{
#ifdef ENABLE_EFFECT_STONE_SYSTEM
		pkInstFind->ChangeArmor(c_rkNetUpdateActorData.m_dwArmor, c_rkNetUpdateActorData.m_dwStoneEffect);
#else
		pkInstFind->ChangeArmor(c_rkNetUpdateActorData.m_dwArmor);
#endif
#ifdef ENABLE_EFFECT_STONE_SYSTEM
		pkInstFind->ChangeWeapon(c_rkNetUpdateActorData.m_dwWeapon, c_rkNetUpdateActorData.m_dwWeaponRareLv, c_rkNetUpdateActorData.m_dwWeaponStoneEffect);
#else
		pkInstFind->ChangeWeapon(c_rkNetUpdateActorData.m_dwWeapon, c_rkNetUpdateActorData.m_dwWeaponRareLv);
#endif
...
#endif
#ifdef ENABLE_BUFFI_SYSTEM
		pkInstFind->SetSupportShaman(c_rkNetUpdateActorData.is_support_shaman);
#endif
	}
...
#endif
#ifdef ENABLE_BUFFI_SYSTEM
	rkNetActorData.is_support_shaman = c_rkNetUpdateActorData.is_support_shaman;
#endif
#ifdef ENABLE_GUILD_LEADER_SYSTEM
	rkNetActorData.m_bMemberType = c_rkNetUpdateActorData.m_bMemberType;
#endif
#ifdef ENABLE_WEAPON_RARITY_SYSTEM
	rkNetActorData.m_dwWeaponRareLv = c_rkNetUpdateActorData.m_dwWeaponRareLv;
#endif
#ifdef ENABLE_EFFECT_STONE_SYSTEM
	rkNetActorData.m_dwStoneEffect = c_rkNetUpdateActorData.m_dwStoneEffect;
#endif
#ifdef ENABLE_AURA_SYSTEM
