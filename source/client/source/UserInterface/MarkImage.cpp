...
bool CGuildMarkImage::SaveBlockFromCompressedData(DWORD posBlock, const BYTE * pbComp, DWORD dwCompSize)
{
	...
	int lzoDecompressResult = lzopro_lzo1x_decompress_a07((const unsigned char*)pbComp, dwCompSize, (BYTE *)apxBuf, (lzo_uint*)&sizeBuf, CLZO::Instance().GetWorkMemory());
...
void SGuildMarkBlock::Compress(const Pixel * pxBuf)
{
	...
	if (LZO_E_OK != lzopro_lzo1x_1_16_compress((const BYTE *) pxBuf,
