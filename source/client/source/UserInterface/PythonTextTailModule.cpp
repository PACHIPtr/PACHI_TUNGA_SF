...
PyObject * textTailShowJustItemTextTail(PyObject * poSelf, PyObject * poArgs)//sadece esyalari goster
{
...
#ifdef PYTHON_DYNAMIC_MODULE_NAME
	PyObject* poModule = Py_InitModule(GetModuleName(TEXT_TAIL_MODULE).c_str(), s_methods);
#else
	PyObject* poModule = Py_InitModule("textTail", s_methods);
#endif
}