...
bool CPythonLauncher::RunLine(const char* c_szSrc)
{
	...
	CHAR __key[] = { 'P', '3', 'B', 'S', 'v', 'D', 'e', 'P', 'G', '8', 'G', '4', 'm', 'p', '2', 'Q', 'Z', 'q', 'P', 'w', '3', 'f', 'j', 'F', 'f', 'M', '8', 'e', '8', 't', 'h', 'c', 0x0};
	CryptoPP::AES::Decryption aesDecryption("P3BSvDePG8G4mp2QZqPw3fjFfM8e8thc", CryptoPP::AES::DEFAULT_KEYLENGTH);
	CryptoPP::CBC_Mode_ExternalCipher::Decryption cbcDecryption( aesDecryption, 16 );

	CryptoPP::StreamTransformationFilter stfDecryptor(cbcDecryption, new CryptoPP::StringSink( decryptedtext ) );
	stfDecryptor.Put(reinterpret_cast<const unsigned char*>(c_szSrc), c_szSrc);
