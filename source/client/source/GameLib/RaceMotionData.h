...
class CRaceMotionData
{
	public:
		...
		enum EMotionEventType
		{
			...
			MOTION_EVENT_TYPE_WOLFMAN_NEW_1,
			MOTION_EVENT_TYPE_WOLFMAN_NEW_2,
		...
		typedef struct NMotionEvent::SMotionEventWolfmanNew1		TMotionWolfmanNew1EventData;
		typedef struct NMotionEvent::SMotionEventWolfmanNew2		TMotionWolfmanNew2EventData;
