...
namespace NMotionEvent
{
	...
	// Wolfman 1
	typedef struct SMotionEventWolfmanNew1 : public SMotionEventData
	{
		SMotionEventWolfmanNew1() {}
		virtual ~SMotionEventWolfmanNew1() {}

		void Save(FILE * File, int iTabs) {}
		void Load() {}
	} TMotionWolfmanNew1EventData;

	// Wolfman 2
	typedef struct SMotionEventWolfmanNew2 : public SMotionEventData
	{
		SMotionEventWolfmanNew2() {}
		virtual ~SMotionEventWolfmanNew2() {}

		void Save(FILE * File, int iTabs) {}
		void Load() {}
	} TMotionWolfmanNew2EventData;
