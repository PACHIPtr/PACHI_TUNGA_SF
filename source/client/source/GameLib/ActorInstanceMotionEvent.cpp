...
#endif
			break;
		case CRaceMotionData::MOTION_EVENT_TYPE_WOLFMAN_NEW_1:
			ProcessMotionEventWolfman1(c_pData);
			break;
		case CRaceMotionData::MOTION_EVENT_TYPE_WOLFMAN_NEW_2:
			ProcessMotionEventWolfman2(c_pData);
			break;
	}
}
...
void CActorInstance::ProcessMotionEventWolfman1(const CRaceMotionData::TMotionEventData * c_pData)
{
	if (CRaceMotionData::MOTION_EVENT_TYPE_WOLFMAN_NEW_1 != c_pData->iType)
		return;
...
void CActorInstance::ProcessMotionEventWolfman2(const CRaceMotionData::TMotionEventData * c_pData)
{
	if (CRaceMotionData::MOTION_EVENT_TYPE_WOLFMAN_NEW_2 != c_pData->iType)
		return;
}
