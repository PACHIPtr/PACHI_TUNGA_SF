...
BOOL CActorInstance::isLock()
{
	...
	switch (dwCurMotionIndex)
	{
		...
		case CRaceMotionData::NAME_ALCOHOL:
		case CRaceMotionData::NAME_SIREN:
		case CRaceMotionData::NAME_WEATHER_1:
		case CRaceMotionData::NAME_WEATHER_2:
		case CRaceMotionData::NAME_WEATHER_3:
		case CRaceMotionData::NAME_WHIRL:
		case CRaceMotionData::NAME_CHARGING:
