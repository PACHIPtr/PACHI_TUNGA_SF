...
#define ENABLE_GROWTH_PET_SYSTEM
		...
		DWORD AttachEffectByID(DWORD dwParentPartIndex, const char * c_pszBoneName, DWORD dwEffectID, const D3DXVECTOR3 * c_pv3Position = nullptr);
	...
	protected:
		...
		void ProcessMotionEventWolfman1(const CRaceMotionData::TMotionEventData * c_pData);
		void ProcessMotionEventWolfman2(const CRaceMotionData::TMotionEventData * c_pData);
