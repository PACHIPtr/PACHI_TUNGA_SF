...
void CEffectMeshInstance::Delete(CEffectMeshInstance* pkMeshInstance)
{
	...
	ms_kPool.Destruct(pkMeshInstance);
}
...
{
	for_each (rkInstance.TextureInstanceVector.begin(), rkInstance.TextureInstanceVector.end(), CEffectMeshInstance_DeleteImageInstance);
	rkInstance.TextureInstanceVector.clear();
}
