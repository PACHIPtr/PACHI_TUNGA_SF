...
CEffectElementBaseInstance::CEffectElementBaseInstance(): mc_pmatLocal (nullptr), m_isActive (false), m_fLocalTime (0), m_dwStartTime (0), m_fElapsedTime (0), m_fRemainingTime (0), m_bStart (false), m_pBase (nullptr)
{
}
