...
#ifdef ENABLE_SHOP_RENEWAL
			void SetSlotStockCount(DWORD dwIndex, DWORD dwCount);
#endif
...
#ifdef ENABLE_ITEM_COLOR_HIGHLIGHT_SYSTEM
			void ActivateSlotColor(DWORD dwIndex, float r, float g, float b, float a);
			void DeactivateSlotColor(DWORD dwIndex);
#endif
			void RefreshSlot();
...
#ifdef ENABLE_ITEM_COLOR_HIGHLIGHT_SYSTEM
			void __CreateSlotColorEnableEffect(float r, float g, float b, float a);
			void __DestroySlotColorEnableEffect();
#endif
...
#ifdef ENABLE_ITEM_COLOR_HIGHLIGHT_SYSTEM
	#ifdef ENABLE_ITEM_HIGHLIGHT_SYSTEM
			CAniImageBox * m_apColorSlotActiveEffect[3];
	#else
			CAniImageBox * m_pColorSlotActiveEffect;
	#endif
#endif
