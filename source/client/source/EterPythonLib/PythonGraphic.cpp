...
void CPythonGraphic::RenderZodiacCoolTimeBox(float fxCenter, float fyCenter, float fRadius, float fTime)
{
	if (fTime >= 1.0f)
		return;
	...
	static D3DXCOLOR color = D3DXCOLOR(0.0f, 0.0f, 0.0f, 255.0f);
