...
GEM_ICON = "d:/ymir work/ui/gemshop/redgemshop_gemicon.sub"
BOARD_WIDTH = 168
BOARD_HEIGHT = 244
window = {
	"name" : "GemShopWindow",
	...
	(
		{
			...
			(
				## Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":BOARD_WIDTH / 2 - 5, "y":3, "text": uiScriptLocale.GEMSHOP_TITLE2, "text_horizontal_align":"center" },
					),
				},
				...
				{ 
					...
					"x":14,
					"y":31, 
					"image": GEM_PATH+"redgemshop_backimg.sub",
				},
