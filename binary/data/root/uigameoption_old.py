...
class OptionDialog(ui.ScriptWindow):
	...
	def __Load_BindObject(self):
		try:
			...
			self.enableAutoPickUpButtonList.append(GetObject("autopickup_on_button"))
	...
	def __Load(self):
		...
		self.enableAutoPickUpButtonList[1].SAFE_SetEvent(self.__OnClickDisableAutoPickUpButton)
