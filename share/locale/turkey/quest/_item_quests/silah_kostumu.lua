	...
	state start begin
		...
		if pc.count_item(30335) < 1 then 
			...
			if nevi2secbakalim == 1 then
				local silah1 = select ("Þeker Çubuðu Býçaðý ","Kesici Diþ Kýlýcý ", "Kullanmak Ýstemiyorum. ")
				if silah1 == 1 then
			...
			if nevi2secbakalim == 2 then
				local hancer1 = select ("Þeker Çubuðu Hançeri ","Kesici Diþ Hançer ", "Kullanmak Ýstemiyorum. ")
				if hancer1 == 1 then
			...
			if nevi2secbakalim == 3 then
				local yay1 = select ("Elf Yayý ","Kesici Diþ Yayý ", "Kullanmak Ýstemiyorum. ")
				if yay1 == 1 then
			...
			if nevi2secbakalim == 4 then
				local ciftel1 = select ("Kurabiye Geniþ Mýzraðý ","Kesici Diþ Mýzraðý ", "Kullanmak Ýstemiyorum. ")
				if ciftel1 == 1 then
			...
			if nevi2secbakalim == 5 then
				local can1 = select ("Þeker Çubuðu Çaný ","Kesici Diþ Çaný ", "Kullanmak Ýstemiyorum. ")
				if can1 == 1 then
			...
			if nevi2secbakalim == 6 then
				local yelpaze1 = select ("Þeker Çubuðu Yelpazesi ","Kesici Diþ Yelpazesi ", "Kullanmak Ýstemiyorum. ")
				if yelpaze1 == 1 then
			...
			if nevi2secbakalim == 7 then
				local pence1 = select ("Rudolph Pençeleri ","Kesici Diþ Pençesi ", "Kullanmak Ýstemiyorum. ")
				if pence1 == 1 then
