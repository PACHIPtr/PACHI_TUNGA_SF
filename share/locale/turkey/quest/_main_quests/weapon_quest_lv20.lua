	...
	state information begin
		...
		when button or info begin
			...
			if pc.job == 0 then
				...
				local s = select(item_name(get_changing_weapon(0, 5)), item_name(get_changing_weapon(0, 6)), "Henüz Deðil.")
				if s == 1 then
			...
			elseif pc.job == 1 then
				...
				local s = select(item_name(get_changing_weapon(1, 7)), item_name(get_changing_weapon(1, 8)), item_name(get_changing_weapon(1, 9)), "Henüz Deðil.")		
				if s == 1 then
			...
			elseif pc.job == 2 then
				...
				say("")
				say("")
				local s = select(item_name(get_changing_weapon(2, 3)), "Henüz Deðil.")						
				if s == 1 then
			...
			elseif pc.job == 3 then
				...
				local s = select(item_name(get_changing_weapon(3, 5)), item_name(get_changing_weapon(3, 6)), "Henüz Deðil.")
				if s == 1 then
			...
			elseif pc.job == 4 then
				...
				say("")
				say("")
				local s = select(item_name(get_changing_weapon(4, 3)), "Henüz Deðil.")						
				if s == 1 then
