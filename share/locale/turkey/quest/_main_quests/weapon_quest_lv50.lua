	...
	state information begin
		...
		when button or info begin
			...
			if pc.job == 0 then
				...
				local s = select(item_name(get_changing_weapon(0, 11)), item_name(get_changing_weapon(0, 12)), "Henüz Deðil.")
				if s == 1 then
			...
			elseif pc.job == 1 then
				...
				local s = select(item_name(get_changing_weapon(1, 16)), item_name(get_changing_weapon(1, 17)), item_name(get_changing_weapon(1, 18)), "Henüz Deðil.")		
				if s == 1 then
			...
			elseif pc.job == 2 then
				...
				say("")
				say("")
				local s = select(item_name(get_changing_weapon(2, 6)), "Henüz Deðil.")						
				if s == 1 then
			...
			elseif pc.job == 3 then
				...
				local s = select(item_name(get_changing_weapon(3, 11)), item_name(get_changing_weapon(3, 12)), "Henüz Deðil.")
				if s == 1 then
			...
			elseif pc.job == 4 then
				...
				say("")
				say("")
				local s = select(item_name(get_changing_weapon(4, 6)), "Henüz Deðil.")						
				if s == 1 then
